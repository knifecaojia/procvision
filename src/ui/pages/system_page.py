...
class SystemPage(QFrame):
    ...
    def init_ui(self):
        ...
        self.relay_open_serial_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.relay_close_serial_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.relay_turn_on_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.relay_turn_off_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
